...
/*can-map-lazy@0.0.0#nested_reference*/
define('can-map-lazy/nested_reference', function (require, exports, module) {
...
/*can-map-lazy@0.0.0#can-map-lazy*/
define('can-map-lazy', function (require, exports, module) {
    var can = require('can/util/util');
    var bubble = require('can-map-lazy/bubble');
    ...
    module.exports = exports = can.LazyMap;
});
/*[global-shim-end]*/
(function (){
